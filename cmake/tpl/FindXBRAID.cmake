...
if(XBRAID_INCLUDES OR XBRAID_LIBRARIES)
  ...
  if(XBRAID_INCLUDES AND XBRAID_LIBRARIES)
    ...
    set(XBRAID_DIR
        ""
        CACHE PATH "Path to the root of XBraid installation" FORCE)
  ...
  set(XBRAID_INCLUDES
      ""
      CACHE STRING "Semi-colon separated list of XBraid include directories"
            FORCE)
  set(XBRAID_LIBRARIES
      ""
      CACHE STRING "Semi-colon separated list of XBraid link libraries" FORCE)
  ...
  foreach(include_dir ${XBRAID_INCLUDES})
    if(EXISTS "${include_dir}/braid.h")
      set(XBRAID_INCLUDE_DIR
          "${include_dir}"
          CACHE "XBraid include directory")
      break()
    endif()
  endforeach()
...
find_package_handle_standard_args(XBRAID REQUIRED_VARS XBRAID_INCLUDE_DIR
                                                       XBRAID_LIBRARY)
...
if(XBRAID_FOUND)
  ...
  set_target_properties(
    SUNDIALS::XBRAID
    PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${XBRAID_INCLUDE_DIR}"
  ...
  if(XBRAID_INCLUDES AND XBRAID_LIBRARIES)
    set(XBRAID_INCS
        "${XBRAID_INCLUDES}"
        CACHE INTERNAL "Internal XBraid includes")
    set(XBRAID_LIBS
        "${XBRAID_LIBRARIES}"
        CACHE INTERNAL "Internal XBraid libraries")
  else()
    set(XBRAID_INCS
        "${XBRAID_INCLUDE_DIR}"
        CACHE INTERNAL "Internal XBraid includes")
