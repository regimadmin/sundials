...
project = "Example Programs for IDAS"
...
htmlhelp_basename = "IDASExampleDoc"
...
latex_documents = [("index", "idas_examples.tex", project, tex_author, "manual", False)]
