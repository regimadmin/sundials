...
project = "User Documentation for ARKODE"
copyright = """2012-{year}, Daniel R. Reynolds, David J. Gardner, Carol S. Woodward, Cody J. Balos, Rujeko Chinomona, and Mustafa Aggul""".format(
    year=year
)
...
man_pages = [
    (
        ...
        [
            "Daniel R. Reynolds, David J. Gardner, Carol S. Woodward, Cody J. Balos, Rujeko Chinomona, and Mustafa Aggul"
        ],
        1,
    )
]
